...
public class Mortgage {
    ...
    public static void root() {
        ...
        //output
        Label lbAns1 = new Label("Monthly Mortgage Payment:" );
        ...
        btn1.setOnAction(e -> {
            try{
            Integer n=12;
            double num1 = Double.parseDouble(txt1.getText()); //Home price
            double num2 = Double.parseDouble(txt3.getText()); //Loan term
            double num3 = Double.parseDouble(txt4.getText()); //Interest rate
            double num4=  Double.parseDouble(txt2.getText());//Down payment
            double num5=  num1-num4;//H.p - D.p

            double res1;
            res1=((num3/n)/100* num5)/(1 - pow((1 +(num3/n)/100 ), -n*num2));
            lbAns.setText(String.format("%.2f",res1));}
        ...
        helpB.setOnAction(e -> Help.MHelp());
        ...
        Pane root = new Pane();
        root.getChildren().addAll(img,btn1,btn3,btnCl1,lbl1,lbl2,lbl3,lbl4,lbl5,lbAns,lbAns1,txt1,txt2,txt3,txt4,helpB,btnKP1,btnKP2,btnKP3,btnKP4,btnKP5,btnKP6,btnKP7,btnKP8,btnKP9,btnKP0,btnKPneq,btnKPdot,btnBS);
